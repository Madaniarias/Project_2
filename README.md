...
|---------|---------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------|---------------|------------------------|-----------|
| 1       | Functional: Testing ability of Raspberry Pi to collect data from the server  | Dec 5 | Open a file called test.py > import the function validate_int_input > ask the user for an input > print the temperature and huminidiry data.  | The Raspberry Pi is able to collect the Temperature and Humidity from the server in intervals of 5 min                 | 
| 2.      | Functional: Testing ability of Raspberry Pi to collect data from the sensors  |  Dec 5 | Open a file called test2.py > import the function validate_choice_input > ask the user for an input > print the temperature and huminidiry data. | The Raspberry Pi is able to collect the Temperature and Humidity from the sensors in intervals of 5 min| 
| 3.      | Functional:    | Dec 11 |  |  
