...
| 4.      | Non-Functional: Capabilty for the user to use understand the graphs　　　　　　| Dec 11           | Open crypto_wallet.py > aske the user to run it for 5 minutes > see how far it gets to use it.  | The user will use at least 5 out of options  | 
